...
class BiasEvaluator(object):
    def __init__(self, pretrained_class="gpt2", no_cuda=False, batch_size=51, input_file="../data/dev.json",
                 ...
                 skip_intrasentence=False, skip_intersentence=True, max_seq_length=64, small=False,
        ...
        print(getattr(transformers, self.TOKENIZER))
    ...
    def evaluate_intrasentence(self):
        ...
        if pretrained_class == "google/flan-t5-small" or self.PRETRAINED_CLASS == "google/flan-t5-small":
            model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-small").to(self.device)
        else:
